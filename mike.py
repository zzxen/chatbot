...
def chat(update : Update , context : CallbackContext):
    ...
    voice_bot = gTTS(text = str(bot_message) , lang = "en" , slow = True)
    file_voice = voice_bot.save("bot.mp3")
    update.message.reply_audio(audio = open("bot.mp3" , "rb") , reply_markup = InlineKeyboardMarkup(keyboards))
